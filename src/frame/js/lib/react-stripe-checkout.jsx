...
// Vendored in to use with the iframe version
...
export default class ReactStripeCheckout extends React.Component {
    ...
    componentDidMount() {
        ...
        scriptLoading = true;
        const {executionContext: {document}} = this.props;
    ...
    renderDefaultStripeButton() {
        return (
            <button {...{ [this.props.triggerEvent]: this.onClick, }}
                ...
                <span style={ Object.assign({}, {
                                  ...
                                  }, this.props.textStyle) }>{ this.props.label }</span>
            </button>
            );
    }
    ...
    render() {
        ...
        if (this.props.children) {
            return (<ComponentClass {...{ [this.props.triggerEvent]: this.onClick, }}
