...
function fetchWeChatQRCode() {
    return function (dispatch, getState) {
        ...
        dispatch((0, _integrationsActions.unsetWeChatError)());
        fetchingWeChat = true;
        return (0, _core.core)(getState()).appUsers.wechat.getQRCode((0, _user.getUserId)(getState())).then(function (_ref) {
            ...
            dispatch((0, _integrationsActions.setWeChatError)());
        }).then(function () {
...
function fetchViberQRCode() {
    return function (dispatch, getState) {
        ...
        dispatch((0, _integrationsActions.unsetViberError)());
        fetchingViber = true;
        return (0, _core.core)(getState()).appUsers.viber.getQRCode((0, _user.getUserId)(getState())).then(function (_ref3) {
            ...
            dispatch((0, _integrationsActions.setViberError)());
        }).then(function () {
            fetchingViber = false;
        });
    };
