...
function fetchMoreMessages() {
    ...
    var _store$getState9$conv = _store$getState9.conversation;
    var hasMoreMessages = _store$getState9$conv.hasMoreMessages;
    var messages = _store$getState9$conv.messages;
    var isFetchingMoreMessagesFromServer = _store$getState9$conv.isFetchingMoreMessagesFromServer;
