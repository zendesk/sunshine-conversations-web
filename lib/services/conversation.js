...
function handleConnectNotification(response) {
    return function (dispatch, getState) {
        var _getState2 = getState(),
            ...
            email = _getState2$user.email,
            _getState2$app = _getState2.app,
            integrations = _getState2$app.integrations,
            settings = _getState2$app.settings,
            messages = _getState2.conversation.messages,
            emailCaptureEnabled = _getState2.appState.emailCaptureEnabled;
...
function connectFayeConversation() {
    return function (dispatch, getState) {
        var _getState3 = getState(),
            conversationSubscription = _getState3.faye.conversationSubscription;
...
function disconnectFaye() {
    return function (dispatch, getState) {
        var _getState5 = getState(),
            _getState5$faye = _getState5.faye,
            conversationSubscription = _getState5$faye.conversationSubscription,
...
function resetUnreadCount() {
    return function (dispatch, getState) {
        var _getState6 = getState(),
            conversation = _getState6.conversation;
...
function handleConversationUpdated() {
    return function (dispatch, getState) {
        var _getState7 = getState(),
            conversationSubscription = _getState7.faye.conversationSubscription;
...
function fetchMoreMessages() {
    return function (dispatch, getState) {
        var _getState8 = getState(),
            _getState8$conversati = _getState8.conversation,
            hasMoreMessages = _getState8$conversati.hasMoreMessages,
            messages = _getState8$conversati.messages,
            isFetchingMoreMessagesFromServer = _getState8$conversati.isFetchingMoreMessagesFromServer;
