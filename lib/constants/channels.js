...
var CHANNEL_DETAILS = exports.CHANNEL_DETAILS = {
    messenger: (0, _extends3.default)({
        ...
        getURL: function getURL(appUser, channel) {
            return 'https://m.me/' + channel.pageId + '?ref=' + appUser._id;
        }
    }),
    ...
    viber: (0, _extends3.default)({
        ...
        Component: !_ismobilejs2.default.any ? _viberChannelContent.ViberChannelContent : undefined,
        onChannelPage: _integrations.fetchViberQRCode,
        getURL: function getURL(appUser, channel) {
            return _ismobilejs2.default.any ? 'viber://pa?chatURI=' + channel.uri + '&context=' + appUser._id : undefined;
        },
    ...
    line: (0, _extends3.default)({
        ...
        getURL: function getURL(appUser, _ref2) {
