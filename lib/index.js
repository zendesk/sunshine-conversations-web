...
var _iframe = __webpack_require__(14);
...
var LIB_FUNCS = ['init', 'login', 'on', 'off', 'logout', 'sendMessage', 'updateUser', 'getConversation', 'getUserId', 'getCore', 'open', 'close', 'isOpened'];
    ...
    if (!iframe) {
        ...
        iframe.onload = function () {
            if (!loaded) {
                ...
                doc.open();
                doc.write('\n                    <!DOCTYPE html>\n                    <html>\n                        <head>\n                            <link rel="stylesheet" href="' + 'https://cdn.smooch.io/frame.4.0.0.css' + '" type="text/css" />\n                            <script src="' + 'https://cdn.smooch.io/frame.4.0.0.min.js' + '" async crossorigin="anonymous"></script>\n                        </head>\n                        <body>\n                            <div id="mount"></div>\n                        </body>\n                    </html>\n                    ');
                doc.close();
            }
        };
    }
...
var _sizes = __webpack_require__(3);
...
var MediaQuery = __webpack_require__(8);
...
var MediaQueryDispatch = __webpack_require__(9);
...
exports.use = exports.ref = function() {
	if(!(refs++)) {
		dispose = __webpack_require__(12)(content, {"insertAt":"bottom"});
	}
	return exports;
};
