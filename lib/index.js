    ...
    if (!iframe) {
        ...
        iframe.onload = function () {
            if (!loaded) {
                ...
                doc.open();
                doc.write('\n                    <!DOCTYPE html>\n                    <html>\n                        <head>\n                            <link rel="stylesheet" href="' + 'https://cdn.smooch.io/frame.4.0.3.css' + '" type="text/css" />\n                            <script src="' + 'https://cdn.smooch.io/frame.4.0.3.min.js' + '" async crossorigin="anonymous"></script>\n                        </head>\n                        <body>\n                            <div id="mount"></div>\n                        </body>\n                    </html>\n                    ');
                doc.close();
            }
        };
    }
