...
var ConnectNotificationComponent = exports.ConnectNotificationComponent = function (_Component) {
    ...
    ConnectNotificationComponent.prototype.render = function render() {
        ...
        var connectNotificationText = _context$ui$text.connectNotificationText;
        var settingsNotificationText = _context$ui$text.settingsNotificationText;
        var settings = _context.settings;
        var _props = this.props;
        var appChannels = _props.appChannels;
        var emailCaptureEnabled = _props.emailCaptureEnabled;
