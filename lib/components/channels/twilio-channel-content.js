...
var TwilioChannelContentComponent = exports.TwilioChannelContentComponent = function (_Component) {
    ...
    TwilioChannelContentComponent.prototype.render = function render() {
        ...
        var _props = this.props,
            appUserNumber = _props.appUserNumber,
            appUserNumberValid = _props.appUserNumberValid,
            phoneNumber = _props.phoneNumber,
            linkState = _props.linkState,
            errorMessage = _props.errorMessage,
            hasError = _props.hasError;
        var _context = this.context,
            linkColor = _context.settings.linkColor,
            _context$ui$text = _context.ui.text,
            smsInvalidNumberError = _context$ui$text.smsInvalidNumberError,
            smsLinkPending = _context$ui$text.smsLinkPending,
            smsStartTexting = _context$ui$text.smsStartTexting,
            smsCancel = _context$ui$text.smsCancel,
            smsChangeNumber = _context$ui$text.smsChangeNumber,
            smsSendText = _context$ui$text.smsSendText,
            smsContinue = _context$ui$text.smsContinue;
