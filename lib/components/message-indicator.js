...
var MessageIndicatorComponent = exports.MessageIndicatorComponent = function (_Component) {
    ...
    MessageIndicatorComponent.prototype.blinkTitle = function blinkTitle() {
        ...
        if (!this.blinkInterval) {
            var fn = function fn() {
                var _context$ui$text = _this2.context.ui.text;
                var messageIndicatorTitleSingular = _context$ui$text.messageIndicatorTitleSingular;
                var messageIndicatorTitlePlural = _context$ui$text.messageIndicatorTitlePlural;
                var unreadCount = _this2.props.unreadCount;
...
MessageIndicatorComponent.contextTypes = {
