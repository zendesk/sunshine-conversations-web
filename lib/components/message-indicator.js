...
var MessageIndicatorComponent = exports.MessageIndicatorComponent = function (_Component) {
    ...
    MessageIndicatorComponent.prototype.blinkTitle = function blinkTitle() {
        ...
        if (!this.blinkInterval) {
            var fn = function fn() {
                ...
                var messageIndicatorTitleSingular = _props.messageIndicatorTitleSingular;
                var messageIndicatorTitlePlural = _props.messageIndicatorTitlePlural;
                var _state = _this2.state;
                var currentTitle = _state.currentTitle;
                var lastSetTitle = _state.lastSetTitle;
    ...
    MessageIndicatorComponent.prototype.cancelBlinking = function cancelBlinking() {
        ...
        var currentTitle = _state2.currentTitle;
        var initialDocumentTitle = _state2.initialDocumentTitle;
...
var MessageIndicator = exports.MessageIndicator = (0, _reactRedux.connect)(function (_ref2) {
    var unreadCount = _ref2.conversation.unreadCount;
    var _ref2$ui$text = _ref2.ui.text;
    var messageIndicatorTitleSingular = _ref2$ui$text.messageIndicatorTitleSingular;
    var messageIndicatorTitlePlural = _ref2$ui$text.messageIndicatorTitlePlural;

    return {
        unreadCount: unreadCount,
        messageIndicatorTitleSingular: messageIndicatorTitleSingular,
        messageIndicatorTitlePlural: messageIndicatorTitlePlural
    };
