...
var ActionComponent = exports.ActionComponent = function (_Component) {
    ...
    ActionComponent.prototype.render = function render() {
        ...
        var actionPaymentCompleted = _context.ui.text.actionPaymentCompleted;
        var _props = this.props;
        var buttonColor = _props.buttonColor;
        ...
        var stripeIntegration = (0, _app.getIntegration)(app.integrations, 'stripeConnect');
        ...
        if (type === 'buy' && stripeIntegration) {
            ...
            if (state === 'offered') {
                ...
                var buttonText = state === 'paid' ? actionPaymentCompleted : _react2.default.createElement(_loading.LoadingComponent, null);
