...
var _quickReplies = require('./quick-replies');
...
var ConversationComponent = exports.ConversationComponent = function (_Component) {
    ...
    function ConversationComponent() {
        ...
        return _ret = (_temp = (_this = (0, _possibleConstructorReturn3.default)(this, _Component.call.apply(_Component, [this].concat(args))), _this), _this.debounceOnScroll = (0, _lodash2.default)(function () {
            ...
            setTimeout(function () {
                (0, _conversation.fetchMoreMessages)();
            }, 400);
        }, _this.scrollToBottom = function () {
            var _this$props3 = _this.props,
                shouldScrollToBottom = _this$props3.shouldScrollToBottom,
                quickReplies = _this$props3.quickReplies,
    ...
    ConversationComponent.prototype.render = function render() {
        ...
        var _props2 = this.props,
            ...
            quickReplies = _props2.quickReplies,
        ...
        if (quickReplies.length > 0) {
            var choices = quickReplies.map(function (_ref) {
                var text = _ref.text,
            ...
            messageItems.push(_react2.default.createElement(_quickReplies.QuickReplies, { ref: _refCallback,
                choices: choices,
                key: 'quick-replies' }));
        }
...
ConversationComponent.propTypes = {
    ...
    quickReplies: _react.PropTypes.array.isRequired
};
