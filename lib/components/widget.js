...
var WidgetComponent = exports.WidgetComponent = function (_Component) {
    ...
    WidgetComponent.prototype.render = function render() {
        ...
        var isBrandColorDark = settings.isBrandColorDark;
        var isAccentColorDark = settings.isAccentColorDark;
        var isLinkColorDark = settings.isLinkColorDark;
        ...
        if (displayStyle === _styles.DISPLAY_STYLE.BUTTON && !appState.embedded) {
            messengerButton = _react2.default.createElement(_messengerButton.MessengerButton, { shown: !appState.widgetOpened });
        }
