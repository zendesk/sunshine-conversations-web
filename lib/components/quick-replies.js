...
var QuickRepliesComponent = exports.QuickRepliesComponent = function (_Component) {
    ...
    function QuickRepliesComponent() {
        ...
        return _ret = (_temp = (_this = (0, _possibleConstructorReturn3.default)(this, _Component.call.apply(_Component, [this].concat(args))), _this), _this.onReplyClick = function (_ref) {
            var text = _ref.text,
    ...
    QuickRepliesComponent.prototype.render = function render() {
        ...
        var items = choices.map(function (_ref2, index) {
            ...
            var icon = iconUrl ? _react2.default.createElement('img', { className: 'sk-quick-reply-icon', alt: 'Icon',
                src: iconUrl }) : null;
